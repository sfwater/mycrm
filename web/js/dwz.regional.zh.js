...
(function($){
	...
	//datepicker
	DPGlobal.days = ["日", "一", "二", "三", "四", "五", "六", "日"];
	DPGlobal.daysMin = ["日", "一", "二", "三", "四", "五", "六", "日"];
	DPGlobal.daysShort = ["日", "一", "二", "三", "四", "五", "六", "日"];
	DPGlobal.months = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'];
	DPGlobal.monthsShort = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'];
})(jQuery);