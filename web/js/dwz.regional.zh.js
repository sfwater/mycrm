...
(function($){
	...
	//datepicker
	DPGlobal.dates.days = ["日", "一", "二", "三", "四", "五", "六", "日"];
	DPGlobal.dates.daysMin = ["日", "一", "二", "三", "四", "五", "六", "日"];
	DPGlobal.dates.daysShort = ["日", "一", "二", "三", "四", "五", "六", "日"];
	DPGlobal.dates.months = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'];
	DPGlobal.dates.monthsShort = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'];
})(jQuery);